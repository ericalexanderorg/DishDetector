...
# Create a cronjob for our dishdetector
crontab -l | { cat; echo "*/10 9-20 * * * SLACK_BOT_TOKEN="replace_with_your_slack_token" python /opt/dishdetector/dishdetector.py"; } | crontab -
